 ...
 *
 */
public class DefaultIAdditive extends AbstractIAdditive {

	private static final DefaultIAdditive INSTANCE
	= new DefaultIAdditive();
	...
	@Override
	public int iAddIdentityElement() {
		return 0;
	}

	@Override
	public int iAddInverse(int a) {
		return -a;
	}
	
	public static DefaultIAdditive getInstance() {
		return INSTANCE;
	}
