...
import org.sglj.math.TAdditive;
 ...
 *
 */
public interface IAdditive extends TAdditive<Integer> {
	public abstract int iAdd(int a, int b);
	public abstract int iAddIdentityElement();
	public abstract int iAddInverse(int a);
}
